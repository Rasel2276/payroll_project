...
// Delete logic thik rakha hoyeche
...
// Attendance Table theke data fetch kora hochhe sathe Users table theke Name ana hochhe
$attendance_list = $conn->query("SELECT a.*, u.name as emp_name 
                                FROM attendance a 
